...
public class SlothModel<T extends Entity> extends QuadrupedModel<T> {
	// This layer location should be baked with EntityRendererProvider.Context in
	// the entity renderer and passed into this model's constructor
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(
			new ResourceLocation(Constants.MOD_ID, "slothmodel"), "main");
	private final ModelPart sloth;

	public SlothModel(ModelPart root)
	{
		super(root, false, 0f, 1F, 1F, 1F, 12);
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition arm_left = legs.addOrReplaceChild("left_front_leg",
		...
		PartDefinition leg_left = legs.addOrReplaceChild("left_hind_leg",
		...
		PartDefinition arm_right = legs.addOrReplaceChild("right_front_leg",
		...
		PartDefinition leg_right = legs.addOrReplaceChild("right_hind_leg",
