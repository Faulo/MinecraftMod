...
public class SlothMossLayer extends RenderLayer<SlothEntity, SlothModel<SlothEntity>> {
	...
	public SlothMossLayer(RenderLayerParent<SlothEntity, SlothModel<SlothEntity>> p_174533_, EntityModelSet p_174534_) {
		super(p_174533_);
		this.model = new SlothMossModel<>(p_174534_.bakeLayer(ModelLayers.SHEEP_FUR));
	}

	public void render(PoseStack p_117421_, MultiBufferSource p_117422_, int p_117423_, SlothEntity p_117424_,
