...
public class SlothMossModel<T extends SlothEntity> extends QuadrupedModel<T> {
	...
	public SlothMossModel(ModelPart p_170900_) {
	...
	public static LayerDefinition createFurLayer() {
		...
		partdefinition.addOrReplaceChild("head", CubeListBuilder.create().texOffs(0, 0).addBox(-3.0F, -4.0F, -4.0F,
				6.0F, 6.0F, 6.0F, new CubeDeformation(0.6F)), PartPose.offset(0.0F, 6.0F, -8.0F));
